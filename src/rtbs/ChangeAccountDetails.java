...
public class ChangeAccountDetails extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (!checkValidity()) {
            JOptionPane.showMessageDialog(null, "Please enter all required details!", "Invalid", JOptionPane.ERROR_MESSAGE);
            return;
        }

        //CODE: Database Code to uprdate data
        Profile p=new Profile();
        JDBConnection jdbc=new JDBConnection();
        jdbc.connect();
        
        p.setUsername(RTBS.currentlyLoggedIn.getUsername());
        p.setFirstName(jTextField1.getText());
        p.setMiddleName(jTextField2.getText());
        p.setLastName(jTextField3.getText());
        p.setAddress(jTextArea1.getText());
        p.setPhone(jTextField4.getText());
        p.setMobile(jTextField5.getText());
        p.setEmail(jTextField6.getText());
        
        jdbc.updateAccount(p);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChangeAccountDetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new ChangeAccountDetails().setVisible(true);
            }
        });
    }
