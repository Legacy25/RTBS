 ...
 * @author Scythe
 */
public class AddPrivilege extends javax.swing.JFrame {

    /**
     * Creates new form AddPrivilege
     */
    String str[][];
    int index;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        JDBConnection jdbc=new JDBConnection();
        jdbc.connect();
        jdbc.addAdministrator(str[index][0]);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddPrivilege.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddPrivilege().setVisible(true);
            }
        });
    }
